            ...
            VStack {
                ...
                if let person = viewModel.person {
                    VStack {
                        ...
                        LoadableImage(url: person.profileImageUI, defaultImage: .movie)
                        ...
                        Text(person.knownForDepartment ?? "Unknown department")
                            .foregroundColor(.white)
                            .font(.system(size: 15))
                            .fontWeight(.medium)
                    }
                    HStack {
                        InfoView(infoType: "Birthday", value: person.birthdayUI ,size: 18)
                        Spacer(minLength: 50)
                        InfoView(infoType: "Place of birth ", value: person.placeOfBirth ,size: 18)
